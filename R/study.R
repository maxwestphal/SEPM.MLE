...
#'
#' @export
study_accuracy <- function(load.folder = "G:/R/MLE_SIM/DATA",
                           load.base = "job",
                           load.id = 8,
                           methods = NA,
                           M = 200,
